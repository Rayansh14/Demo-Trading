    ...
    var body: some View {
        ZStack {
            TabView {
                ...
                TipsPageView(title: "Positions", text: "This is your positions tab. Stocks that you buy will appear here on the day that they are bought. You can also see details about your stocks like avg price bought, number of shares owned, profit/loss, etc. Go to your watchlist, tap on a stock and buy it to get started!", imageName: "positions")
                
                TipsPageView(title: "Holdings", text: "This is your holdings tab. Stocks that you have been holding for more than a day will appear here. You can also see the overall details of your holdings, like total invested amount and profit/loss. If this is not empty, then you have been using this app for more than a day. 🤩🙃", imageName: "holdings")
...
struct TipsView_Previews: PreviewProvider {
    ...
    // Welocome to Demo Trading! This app is meant to help you get started with investing in the stock market. You have been given  am i not absolutely sure then what is the time if 
